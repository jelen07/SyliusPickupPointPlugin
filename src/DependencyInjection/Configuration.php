            ...
            ->children()
                ...
                ->arrayNode('providers')
                    ...
                    ->children()
                        ...
                        ->end()
                        ->booleanNode('zasilkovna')
                            ->example(true)
                            ->info('Whether to enable the Zásilkovna provider')
                            ->defaultValue(false)
                        ->end()
                        ->booleanNode('ulozenka')
                            ->example(true)
                            ->info('Whether to enable the Uloženka provider')
                            ->defaultValue(false)
                        ->end()
                        ->booleanNode('balik_na_postu')
                            ->example(true)
                            ->info('Whether to enable the Balík na poštu provider')
                            ->defaultValue(false)
                        ->end()
                    ->end()
                ->end()
